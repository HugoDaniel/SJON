...
| [`llm/`](llm/README.md) | SJON packaged for LLM authors: a paste-into-context `PRIMER.md`, ten worked write→validate→repair flows, and a token-efficiency receipt against JSON plus JSON Schema. Byte-diffed by `zig build llm-pack-verify`. |
